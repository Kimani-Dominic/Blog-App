        ...
        <div className="post-main">
          ...
          <ul className="grid-list">
            <li>
              <div className="recent-post-card">
                <figure className="card-banner img-holder" style={{ "--width": 271, "--height": 258 }}>
                  <img src="./src/assets/images/recent-post-1.jpg" width="271" height="258" loading="lazy" alt="Helpful Tips for Working from Home as a Freelancer" className="img-cover" />
                </figure>
            ...
            <li>
              <div className="recent-post-card">
                <figure className="card-banner img-holder" style={{ "--width": 271, "--height": 258 }}>
                  <img src="./src/assets/images/recent-post-2.jpg" width="271" height="258" loading="lazy" alt="Helpful Tips for Working from Home as a Freelancer" className="img-cover" />
                </figure>
                <div className="card-content">
                  <a href="#" className="card-badge">Working Tips</a>
                  <h3 className="headline headline-3 card-title">
            ...
            <li>
              <div className="recent-post-card">
                <figure className="card-banner img-holder" style={{ "--width": 271, "--height": 258 }}>
                  <img src="./src/assets/images/recent-post-3.jpg" width="271" height="258" loading="lazy" alt="Helpful Tips for Working from Home as a Freelancer" className="img-cover" />
                </figure>
                <div className="card-content">
                  <a href="#" className="card-badge">Working Tips</a>
                  <h3 className="headline headline-3 card-title">
            ...
            <li>
              <div className="recent-post-card">
                <figure className="card-banner img-holder" style={{ "--width": 271, "--height": 258 }}>
                  <img src="./src/assets/images/recent-post-4.jpg" width="271" height="258" loading="lazy" alt="Helpful Tips for Working from Home as a Freelancer" className="img-cover" />
                </figure>
                <div className="card-content">
                  <a href="#" className="card-badge">Working Tips</a>
                  <h3 className="headline headline-3 card-title">
            ...
            <li>
              <div className="recent-post-card">
                <figure className="card-banner img-holder" style={{ "--width": 271, "--height": 258 }}>
                  <img src="./src/assets/images/recent-post-5.jpg" width="271" height="258" loading="lazy" alt="Helpful Tips for Working from Home as a Freelancer" className="img-cover" />
                </figure>
                <div className="card-content">
                  <a href="#" className="card-badge">Working Tips</a>
                  <h3 className="headline headline-3 card-title">
          ...
          <div className="card aside-card">
            ...
            <ul className="popular-list">
              <li>
                <div className="popular-card">
                  <figure className="card-banner img-holder" style={{ "--width": 64, "--height": 64 }}>
                    <img src="./src/assets/images/popular-post-1.jpg" width="64" height="64" loading="lazy" alt="Creating is a privilege but it’s also a gift" className="img-cover" />
                  </figure>
                  <div className="card-content">
              ...
              <li>
                <div className="popular-card">
                  <figure className="card-banner img-holder" style={{ "--width": 64, "--height": 64 }}>
                    <img src="./src/assets/images/popular-post-2.jpg" width="64" height="64" loading="lazy" alt="Creating is a privilege but it’s also a gift" className="img-cover" />
                  </figure>
                  <div className="card-content">
                    <h4 className="headline headline-4 card-title">
                      <a href="#" className="link hover-2">Creating is a privilege but it’s also a gift</a>
              ...
              <li>
                <div className="popular-card">
                  <figure className="card-banner img-holder" style={{ "--width": 64, "--height": 64 }}>
                    <img src="./src/assets/images/popular-post-3.jpg" width="64" height="64" loading="lazy" alt="Creating is a privilege but it’s also a gift" className="img-cover" />
                  </figure>
                  <div className="card-content">
                    <h4 className="headline headline-4 card-title">
                      <a href="#" className="link hover-2">Creating is a privilege but it’s also a gift</a>
              ...
              <li>
                <div className="popular-card">
                  <figure className="card-banner img-holder" style={{ "--width": 64, "--height": 64 }}>
                    <img src="./src/assets/images/popular-post-4.jpg" width="64" height="64" loading="lazy" alt="Creating is a privilege but it’s also a gift" className="img-cover" />
                  </figure>
                  <div className="card-content">
                    <h4 className="headline headline-4 card-title">
                      <a href="#" className="link hover-2">Creating is a privilege but it’s also a gift</a>
              ...
              <li>
                <div className="popular-card">
                  <figure className="card-banner img-holder" style={{ "--width": 64, "--height": 64 }}>
                    <img src="./src/assets/images/popular-post-5.jpg" width="64" height="64" loading="lazy" alt="Creating is a privilege but it’s also a gift" className="img-cover" />
                  </figure>
                  <div className="card-content">
                    <h4 className="headline headline-4 card-title">
                      <a href="#" className="link hover-2">Creating is a privilege but it’s also a gift</a>
            ...
            <ul className="comment-list">
                ...
                <div className="comment-card">
                  ...
                  <div className="profile-card">
                    <figure className="profile-banner img-holder">
                      <img src="./src/assets/images/author-6.png" width="32" height="32" loading="lazy" alt="Jane Cooper" />
                    </figure>
                    <div>
              ...
              <li>
                <div className="comment-card">
                  ...
                  <div className="profile-card">
                    <figure className="profile-banner img-holder">
                      <img src="./src/assets/images/author-8.png" width="32" height="32" loading="lazy" alt="Jane Cooper" />
                    </figure>
                    <div>
                      <p className="card-title">Jane Cooper</p>
                      <time className="card-date" dateTime="2022-04-15">15 April 2022</time>
              ...
              <li>
                <div className="comment-card">
                  ...
                  <div className="profile-card">
                    <figure className="profile-banner img-holder">
                      <img src="./src/assets/images/author-7.png" width="32" height="32" loading="lazy" alt="Jane Cooper" />
                    </figure>
                    <div>
                      <p className="card-title">Jane Cooper</p>
                      <time className="card-date" dateTime="2022-04-15">15 April 2022</time>
        ...
        {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((index) => (
          <li key={index}>
            <a href="#" className="insta-post img-holder" style={{ "--width": 276, "--height": 277 }}>
              <img src={`./src/assets/images/insta-post-1.png`} width="276" height="277" loading="lazy" alt="insta post" className="img-cover" />
            </a>
          </li>
        ))}
      </ul>
